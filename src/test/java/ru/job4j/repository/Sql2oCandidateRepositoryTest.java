...
class Sql2oCandidateRepositoryTest {
    ...
    @Test
    public void whenEmptyThenNothingFound() {
    ...
    @Test
    public void whenDeleteNotExistIdThenGetFalse() {
    ...
    public void whenFindAll() {
        ...
        var candidate2 = sql2oCandidateRepository.save(new Candidate(0, "name2", "description", creationDate, 2, file.getId()));
        var candidate3 = sql2oCandidateRepository.save(new Candidate(0, "name3", "description", creationDate, 3, file.getId()));
        var candidate4 = sql2oCandidateRepository.save(new Candidate(0, "name4", "description", creationDate, 3, file.getId()));
        var result = sql2oCandidateRepository.findAll();
        assertThat(result).isEqualTo(List.of(candidate1, candidate2, candidate3, candidate4));
    }

    @Test
    public void whenUpdateThenGetUpdated() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var candidate = sql2oCandidateRepository.save(new Candidate(0, "name1", "description", creationDate, 1, file.getId()));
    ...
    @Test
    public void whenUpdateNotExistingCandidateThenGetFalse() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var candidate = new Candidate(0, "name1", "description", creationDate, 1, file.getId());
